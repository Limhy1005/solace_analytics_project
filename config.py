...
# --- LLM Models ---
PLANNING_MODEL_NAME = "openai/" + os.environ.get("LLM_SERVICE_PLANNING_MODEL_NAME", "gemini-2.5-flash")
GENERAL_MODEL_NAME = "openai/" + os.environ.get("LLM_SERVICE_GENERAL_MODEL_NAME", "gemini-2.5-flash-lite")
